      ...
      >
        <div className=" 2xl:w-[1150px] xl:w-[1050px]  md:w-4/5 flex justify-center bg-bgDark1 pt-12 lg:pt-24 pb-8 lg:pb-20 mx-auto lg:flex-row flex-col">
          <div className="w-3/4 lg:w-1/2 flex flex-col lg:mx-unset mx-auto">
            <span className="block-subtitle">Acelera tu Aprendizaje</span>
            <h2 className="mt-10 mb-8 text-4xl lg:text-5xl block-big-title">
              Practica &amp; Aprende sin Complicaciones
            </h2>
            <p className="mb-16 text-secondaryText leading-loose">
              PlayJS te permite practicar JavaScript y TypeScript sin instalar nada. 
              Con testing integrado, resultados en tiempo real y la posibilidad de compartir 
              tu código con otros. Aprende a tu ritmo sin límites.
            </p>
            <button
