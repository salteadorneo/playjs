        ...
        >
          ...
          <section className='flex items-center justify-between gap-2 bg-none border-none text-[#858585] p-1 cursor-default'>
            ...
            <div className='flex gap-1'>
              <button className={language !== LANGUAGE.JAVASCRIPT ? 'grayscale' : ''} onClick={() => setLanguage(LANGUAGE.JAVASCRIPT)}>
              ...
              <button className={language !== LANGUAGE.TYPESCRIPT ? 'grayscale' : ''} onClick={() => setLanguage(LANGUAGE.TYPESCRIPT)}>
